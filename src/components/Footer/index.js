    ...
    <div className="footer-wrapper-primary">
      <div className="footer-content-wrap grid-col-4">
        ...
        <div>
          ...
          <p>
            Cl. 77 #45-28, Aranjuez, Medellín, Aranjuez, Medellín, Antioquia,
            Colombia
          </p>
        ...
        <div>
          <h1 className="center-txt-768">
            {language === 'es' ? 'Redes Sociales' : 'Socials'}
          </h1>
          <div className="footer-interactive-wrapper">
            <Link
              className="footer-contact-interactive"
              target="_blank"
              to="https://www.instagram.com/fundacionwaima?igsh=cTgyNzEycnZubTdk"
            >
              <i className="pi pi-instagram" style={{ fontSize: '2.3rem' }}></i>
            </Link>
            <Link
              className="footer-contact-interactive"
              target="_blank"
              to="https://www.youtube.com/watch?v=v7Eilw0J_qo"
            >
              <i className="pi pi-youtube" style={{ fontSize: '2.3rem' }}></i>
            </Link>
            <Link
              className="footer-contact-interactive"
              target="_blank"
              to="https://www.facebook.com/fundacionwaima?rdid=UWhz0ZNFsFb6xIq1&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F18dDbxrTB4%2F#"
            >
              <i className="pi pi-facebook" style={{ fontSize: '2.3rem' }}></i>
            </Link>
          </div>
        </div>
        <Divider className="span-4 marginTop-2rem" />
        <p className="span-4 footer-copyright">
          © {language == 'es' ? 'FUNDACIÓN' : 'Foundation'} WAIMA- 2025
        </p>
      </div>
    </div>
  )
